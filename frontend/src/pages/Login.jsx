...
// After signup, we redirect to /login (backend doesn't issue a token on signup).
// Login.jsx already redirects to role home after login.
...
export default function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      await signup(form);
      setSuccess(true);
      // Redirect to login — backend issues token on login, not signup
  ...
  return (
    <div style={{ display: "flex", minHeight: "100vh" }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{ background: "white", borderRadius: 12, padding: "8px 12px", display: "inline-block", marginBottom: 24 }}>
            <img src={logo} alt="MediCore" style={{ height: 48, width: "auto", objectFit: "contain", display: "block" }} />
          </div>

          <p style={{ fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase", opacity: 0.65, marginBottom: 14 }}>
            Create your account
          </p>
          <h1 style={{ fontSize: 34, fontWeight: 600, lineHeight: 1.2, marginBottom: 18 }}>
        ...
        <span style={{ fontSize: 12, opacity: 0.4 }}>MediCore · SWE Lab 2026</span>
      </div>
      ...
      <div style={{
        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          <div style={{ marginBottom: 32 }}>
            <p style={{ fontSize: 13, color: "var(--text-muted)", marginBottom: 6 }}>New here?</p>
            <h2 style={{ fontSize: 26, fontWeight: 600, color: "var(--text)" }}>Create account</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <select className="form-control form-select" name="role" value={form.role} onChange={handleChange}>
                {ROLES.map((r) => (
